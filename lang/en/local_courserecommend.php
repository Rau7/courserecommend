...
$string['privacy:metadata:courserecommend'] = 'Information about course recommendations';
$string['privacy:metadata:courserecommend:courseid'] = 'The ID of the recommended course';
$string['privacy:metadata:courserecommend:userid'] = 'The ID of the user who made the recommendation';
$string['privacy:metadata:courserecommend:recommendedto'] = 'The ID of the user who received the recommendation';
$string['privacy:metadata:courserecommend:timemodified'] = 'The time when the recommendation was made';
